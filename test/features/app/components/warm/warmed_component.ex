defmodule HologramFeatureTests.Components.Warm.WarmedComponent do
  use Hologram.Component

  prop :scope, :string, from_context: {:warm, :scope}, default: "DEFAULT"

  # Client-side init (used when the component is warmed off-DOM and when it is first rendered).
